...
if __name__ == '__main__':
    ...
    ax1.grid(False)
    ax1.set_title('Confusion Matrix: Zero Shot Annotation',fontsize=16,fontweight='bold',pad=20)
    ax1.tick_params(axis='both', length=0)
    plt.tight_layout()
    fig1.savefig('gemini_zero_confusion_matrix.png', dpi=300)
    ...
    plt.tight_layout()
    fig2.savefig('zero_gemini.png', dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    fig_p.savefig('precision_gemini_zero.png', dpi=300)
    ...
    plt.tight_layout()
    fig_r.savefig('recall_gemini_zero.png', dpi=300)
    ...
    plt.tight_layout()
    fig_f.savefig('f1_gemini_zero.png', dpi=300)
