...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig1.savefig('gemini_few_confusion_matrix.png', dpi=300)
    ...
    plt.tight_layout()
    fig2.savefig('few_gemini.png', dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    fig_p.savefig('precision_gemini_few.png', dpi=300)
    ...
    plt.tight_layout()
    fig_r.savefig('recall_gemini_few.png', dpi=300)
    ...
    plt.tight_layout()
    fig_f.savefig('f1_gemini_few.png', dpi=300)
