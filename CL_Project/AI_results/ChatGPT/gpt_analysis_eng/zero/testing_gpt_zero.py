...
if __name__ == '__main__':
    ...
    plt.tight_layout()
    fig1.savefig('gpt_zero_confusion_matrix.png', dpi=300)
    ...
    plt.tight_layout()
    fig2.savefig('zero_gpt.png', dpi=300, bbox_inches='tight')
    ...
    plt.tight_layout()
    fig_p.savefig('precision_gpt_zero.png', dpi=300)
    ...
    plt.tight_layout()
    fig_r.savefig('recall_gpt_zero.png', dpi=300)
    ...
    plt.tight_layout()
    fig_f.savefig('f1_gpt_zero.png', dpi=300)
